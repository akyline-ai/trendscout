...
const APP_URL = import.meta.env.VITE_APP_URL || 'https://app.rizko.ai';
...
export function LandingPage() {
  ...
  // Theme state (standalone, no context needed)
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li><a href={`${APP_URL}/help`} className="hover:text-gray-900 dark:hover:text-white transition-colors">Help Center</a></li>
                <li><a href={`${APP_URL}/help`} className="hover:text-gray-900 dark:hover:text-white transition-colors">FAQ</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              &copy; 2026 Rizko.ai. All rights reserved.
            </p>
